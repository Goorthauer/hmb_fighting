...
func (m *MockDatabase) GetCharacters() ([]Character, error) {
	return []Character{
		...
		{
			ID: 11, Name: "Vitya", Team: 1, HP: 20, Stamina: 6, AttackMin: 8, AttackMax: 18, Defense: 5, Initiative: 6,
			Weapon: "falchion", Shield: "shield", Height: 174, Weight: 80, Position: [2]int{14, 8},
			CountOfAbility: 3,
			ImageURL:       "./static/characters/default.png",
		},
		{
			ID: 12, Name: "Vetalique", Team: 0, HP: 20, Stamina: 6, AttackMin: 8, AttackMax: 18, Defense: 5, Initiative: 12,
			Weapon: "falchion", Shield: "shield", Height: 174, Weight: 80, Position: [2]int{14, 8},
			IsTitanArmour:  true,
			Attack:         5,
			Wrestling:      5,
