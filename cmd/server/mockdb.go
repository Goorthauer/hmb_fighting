...
func (m *MockDatabase) GetCharacters() ([]Character, error) {
	return []Character{
		...
		{ID: 3, Name: "Alexei", Team: 0, HP: 10, Stamina: 7, AttackMin: 12, AttackMax: 22, Defense: 4, Initiative: 9, Weapon: "two_handed_sword", Shield: "", Height: 185, Weight: 95, Position: [2]int{4, 4}, Abilities: []string{"pin"}, ImageURL: "./static/characters/benya.png"},
